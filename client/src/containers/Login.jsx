        ...
        <div className=' w-screen h-screen relative overflow-hidden flex'>
            ...
            <div className=" flex flex-col items-center bg-lightOverlay w-[80%] md:w-508 h-full z-10 backdrop-blur-md p-4 px-4 py-12 gap-6">
                ...
                <div className=" flex items-center justify-start gap-4 w-full">
                    ...
                    <p className=' text-headingColor font-semibold text-2xl'>FoodHub</p>
                </div>
                ...
                <div className=" w-full flex flex-col items-center justify-center gap-6 px-4 md:px-12 py-4">
                    ...
                    {!isSignUp ? (
                        ...
                        : (
                            <p>Already have an account:{" "} <motion.button {...buttonClick} className=' text-red-400 underline cursor-pointer bg-transparent' onClick={() => setIsSignUp(false)}>Sign-in Here</motion.button></p>
                        )}


                    {/* button secton */}
                    {isSignUp ? (
                        <motion.button {...buttonClick} className=' w-full px-4 py-2 rounded-md bg-red-400 cursor-pointer text-white text-xl capitalize hover:bg-red-500 transition-all duration-150' onClick={signUpWithEmailPass}>
                            Sign Up
                        </motion.button>
                    ) : (
                ...
                <motion.div {...buttonClick} onClick={loginWithGoogle} className=' flex items-center justify-center px-20 py-2 bg-lightOverlay backdrop-blur-md cursor-pointer rounded-3xl gap-4'>
                    <FcGoogle className=' text-3xl' />
                    <p className=' capitalize text text-base text-headingColor'>Signin with Google</p>
                </motion.div>
            </div>

    ...
    return (
        <div className=' h-full py-12 flex flex-col bg-lightOverlay backdrop-blur-md shadow-md min-w-210 w-300 gap-3'>
            <NavLink to={"/"} className=" flex items-center justify-start px-6 gap-4">
                ...
                <p className=' font-semibold text-xl'>FoodHub</p>
            </NavLink>
            ...
            <ul className=' flex flex-col gap-4'>
                ...
                <NavLink className={({ isActive }) => isActive ? `${isActiveStyles} px-4 py-2 border-l-8 border-red-500` : isNotActiveStyles} to={"/dashboard/newItems"}>Add New Items</NavLink>
